import { CardStateSchema } from "@house-manager/srs";
...
// Singleton board for the alchemy drag-and-drop demo (proves @house-manager/cards
...
// keyed by flashcard id. Static curriculum content lives in @house-manager/curriculum;
