// @house-manager/cards — portable drag-and-drop card primitives.
//
...
//
//   import { Card } from "@house-manager/cards";
//   import "@house-manager/cards/theme"; // default tokens (override any --mp-card-*)
