...
Authoritative contract for the house-manager skill collection. Every later prompt that builds a `SKILL.md` must read and obey this file. CLAUDE.md owns the Four Pillars and stack pins; skills do not restate Pillar text — they reference Pillars by name only.
