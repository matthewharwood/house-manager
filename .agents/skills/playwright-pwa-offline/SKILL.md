...
test("a previously-visited app resolves a deep URL while offline", async ({ page, context }) => {
  ...
  await page.evaluate(async () => {
    const open = indexedDB.open("house-manager");
